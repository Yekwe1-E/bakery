...
async function runMigrations() {
    try {
        ...
        const newProducts = [
            ...
            ['Puff Puff (Bag)', 'Deep-fried dough balls, light and airy', 1500.00, 'https://images.unsplash.com/photo-1574484284002-952d92456975?w=400', 4, 50],
        ...
        await pool.execute(
            ...
            ['https://images.unsplash.com/photo-1605286822615-dca5f78f9e67?w=400', 'Banana Bread']
        );
        await pool.execute(
            `UPDATE products SET image = ? WHERE name = ?`,
            ['https://images.unsplash.com/photo-1574484284002-952d92456975?w=400', 'Puff Puff (Bag)']
        );
        console.log('✅ Migration: Product images updated');
